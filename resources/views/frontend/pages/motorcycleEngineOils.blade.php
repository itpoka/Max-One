...
<section class=" d-flex align-items-center text-white  mb-5" 
...
<div class="d-flex align-items-center justify-content-center mb-4">
  ...
  <h3 class="px-3 m-0 fw-bold" style="font-size:18px;">Full-Synthetic</h3>
  <div class="flex-grow-1 border-top"></div>
</div>
...
<div class="container py-5">
 <div class="d-flex align-items-center justify-content-center mb-4">
  <div class="flex-grow-1 border-top"></div>
  <h3 class="px-3 m-0 fw-bold" style="font-size:18px;">Synthetic-Technology</h3>
  <div class="flex-grow-1 border-top"></div>
</div>
...
<div class="container py-5">
 <div class="d-flex align-items-center justify-content-center mb-4">
  <div class="flex-grow-1 border-top"></div>
  <h3 class="px-3 m-0 fw-bold" style="font-size:18px;">Mineral</h3>
  <div class="flex-grow-1 border-top"></div>
</div>
