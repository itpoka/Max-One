                ...
                <div class="menu-inner">
                    <nav>
                        <ul class="metismenu" id="menu">
                            ...
                            <li>
                                <a href="javascript:void(0)" aria-expanded="true"><i class="ti-layout-sidebar-left"></i><span>Product Related Data 
                                    </span></a>
                                <ul class="collapse">
                                    <li><a href="{{route('backend.oil.type.index')}}">Oil Type</a></li>
